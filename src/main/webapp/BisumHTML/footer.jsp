                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        <li class="footer-menu-item"><a href="about-us.html">오픈예정</a></li>
                                        <li class="footer-menu-item"><a href="about-us.html">펀딩프로젝트</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        ...
                                        <li class="footer-menu-item"><a href="about-us.html">Contact</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <div class="footer-newsletter">
                                        <p class="footer-text mb-3">책과 함께하는 크라우딩의 여정</p>
