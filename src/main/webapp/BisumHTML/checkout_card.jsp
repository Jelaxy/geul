						...
						<div class="row">
							<div class="col-xl-9 col-lg-8 col-md-12 col-12">
								<div class="section-header mb-3">
									<h2 class="section-heading">카드 정보</h2>
								</div>
								...
								<div class="shipping-address-area">
									...
									<div class="shipping-address-form-wrapper">
										<form action="insCard.do" method="post"
											class="shipping-address-form common-form">

											<div class="row">
												<div class="col-lg-6 col-md-12 col-12">
													<fieldset>
														<label class="label">카드 번호</label> <input type="number"
															id="paycard_number" name="paycard_number" />
													</fieldset>
												</div>
												<div class="col-lg-6 col-md-12 col-12">
													<fieldset>
														...
														<input type="text" value='<fmt:formatDate pattern="yyyy-MM-dd"value="${board.regdte}"/>'>
													</fieldset>
												</div>
												<div class="col-lg-6 col-md-12 col-12">
													<fieldset>
														<label class="label">cvc</label> <input type="number"
															id="cvc" name="cvc" placeholder="카드 뒷면 3자리를 입력해주세요" />
													</fieldset>
												</div>
											</div>
											...
											<button type="submit">카드 정보 저장</button>
										</form>
									</div>
								</div>
								...
								<div class="shipping-address-area billing-area">
									<div
										...
										<a href="checkout_shipping.jsp"
											class="checkout-page-btn minicart-btn btn-secondary">카드정보로
											돌아가기</a> <a href="geul_checkout.html"
											class="checkout-page-btn minicart-btn btn-primary">결제 예약
											완료하기</a>
									</div>
								</div>
							</div>
				...
				<div
					...
					<div class="minicart-footer">
						...
						<div
							...
							<a href="checkout_reward.jsp" class="minicart-btn btn-secondary">View
