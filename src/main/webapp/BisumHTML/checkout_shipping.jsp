...
<body>
	<div class="body-wrapper">
		...
		<main id="MainContent" class="content-for-layout">
			<form id="shipping" method="post" action="getAddress.do">
								...
								<div class="col-xl-9 col-lg-8 col-md-12 col-12">
									...
									<div class="checkout-progress overflow-hidden">
										<ol class="checkout-bar px-0">
											...
											<li class="progress-step step-active"><a
												href="checkout.html">배송 정보</a></li>
											<li class="progress-step step-todo"><a
												href="checkout.html">카드 정보</a></li>
											<li class="progress-step step-todo"><a
									...
									<div class="col-xl-3 col-lg-4 col-md-12 col-12">
										<div class="cart-total-area checkout-summary-area">
											<h3
												class="d-none d-lg-block mb-0 text-center heading_24 mb-4">
												리워드 정보</h3>

											<div class="minicart-item d-flex">
												<div class="mini-img-wrapper">
													<img class="mini-img" src="${param.img}" alt="img">
												</div>
												<div class="product-info">
													<h2 class="product-title">
														<a href="#">${param.title}</a>
													</h2>
													<p class="product-vendor">${param.price}원</p>
												</div>
											</div>
 ...
 -->
										...
										<div class="shipping-address-form-wrapper">
											<div class="row">
												<div class="col-lg-6 col-md-12 col-12">
													<fieldset>
														<label class="label">성함</label> <input type="text"
															id="name" name="name" />
													</fieldset>
												</div>
												<div class="col-lg-6 col-md-12 col-12">
													<fieldset>
														<label class="label">휴대폰 번호</label> <input type="text"
															id="phn_num" name="phn_num" />
													</fieldset>
												</div>
												<div class="col-lg-6 col-md-12 col-12">
													<fieldset>
														<label class="label">이메일</label> <input type="text"
															id="email" name="email" />
													</fieldset>
												</div>
												<div class="col-lg-6 col-md-12 col-12">
													<fieldset>
														<label class="label">우편번호</label> <input type="text"
															id="ad_num" name="ad_num"> <input type="button"
															onclick="execDaumPostcode()" value="우편번호 찾기">
													</fieldset>
												</div>
												<div class="col-lg-6 col-md-12 col-12">
													<fieldset>
														<label class="label">도로명주소</label> <input type="text"
															id="ad_normal" name="ad_normal" style="width: 500px">
													</fieldset>
												</div>
												<div class="col-lg-6 col-md-12 col-12">
													<fieldset>
														<label class="label">상세 주소</label> <input type="text"
															id="ad_detail" name="ad_detail" style="width: 500px">
													</fieldset>
												</div>
														...
														new daum.Postcode(
																{
																	oncomplete : function(
																			data) {
																		document
																				.getElementById('ad_num').value = data.zonecode;
																		document
																				.getElementById('ad_normal').value = data.address;
																	}
																}).open();
													}
												</script>
									...
									<div class="shipping-address-area billing-area">
										...
										<div class="form-checkbox d-flex align-items-center mt-4">
											...
											<label class="form-check-label ms-2"> 주문자 주소와 동일합니다 </label>
										</div>
									</div>
									<div class="shipping-address-area billing-area">
										<div
											class="minicart-btn-area d-flex align-items-center justify-content-between flex-wrap">
											<a href="checkout_reward.jsp"
												class="checkout-page-btn minicart-btn btn-secondary">리워드
												선택으로 돌아가기</a> <a href="${path}/insCard.do"
												class="checkout-page-btn minicart-btn btn-primary">카드 정보
												입력하기</a>
										</div>
									</div>
								</div>
