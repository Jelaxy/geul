                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="filter-sort-wrapper d-flex justify-content-between flex-wrap">
                                <div class="collection-title-wrap d-flex align-items-end">
                                    <h2 class="collection-title heading_24 mb-0">오픈 예정</h2>
                                        ...
                                        <div class="product-card">
                                            <div class="product-card-img">
                                                <a class="hover-switch" href="collection-left-sidebar.html">
                                                    ...
                                                    <img class="primary-img" src="assets/img/project/thumbnail/id_01.jpg"
                                                        alt="product-img">
                                                </a>

                                                <div class="product-badge">
												    <span class="badge-label badge-percentage rounded">오픈예정</span>
												</div>
                                                ...
                                                <div
                                                    ...
                                                    <a href="#" class="action-card action-wishlist">
													    <svg class="icon icon-notification" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
												...
												<div class="product-card-details">
												    <div class="product-card-title-container">
												        ...
												        <span class="dday">D-DAY</span><br>
												            <a href="collection-left-sidebar.html">제목     </a> <br>
												            <a href="collection-left-sidebar.html">소개글~~~입니다</a>
												        </h3>
												    </div>
												    <br>
												    <button type="submit" class="position-relative review-submit-btn contact-submit-btn" style="display: block; margin: 0 auto;">알림신청하기</button>
												</div>
                                        </div>
                                    </div>
