     ...
     <div class="body-wrapper">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-12 col-12">
                                ...
                                <div class="checkout-progress overflow-hidden">
                                    <ol class="checkout-bar px-0">
                                        <li class="progress-step step-active"><a href="geul_reward.html">리워드 선택</a></li>
                                        <li class="progress-step step-todo"><a href="geul_shipping.html">배송 정보</a></li>
                                        <li class="progress-step step-todo"><a href="geul_card.html">카드 정보</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart-item">
                                          ...
                                          <td class="cart-item-details">
                                            ...
                                            <p class="product-vendor">옵션 - 얼리버드 할인</p>                                   
                                          </td>
                                          <td class="cart-item-quantity">
                                            ...
                                            <a href="#" class="product-remove mt-2">삭제</a>                           
                                          </td>
                                          <td class="cart-item-price text-end">
                                            <div class="product-price" name="reward-price">24,000원</div>                           
                                          </td>                        
                                        </tr>
                                        ...
                                        <tr class="cart-item">
                                          ...
                                          <td class="cart-item-details">
                                            <h2 class="product-title"><a href="#">강남에서 살아남기</a></h2>
                                            <p class="product-vendor">옵션 - 얼리버드 할인</p>                                   
                                          </td>
                                          <td class="cart-item-quantity">
                                            <div class="quantity d-flex align-items-center justify-content-between">
                                          ...
                                          <td class="cart-item-price text-end">
                                            <div class="product-price">24,000원</div>                           
                                          </td>
                                        </tr>
                            ...
                            <div class="col-lg-5 col-md-12 col-12">
                                <div class="cart-total-area">
                                  <div class="subtotal-item total-price-box">
                                    ...
                                    <p class="subtotal-value" name="total-price">0원</p>
                                  </div>
        ...
        <script>
            ...
            function updateTotalPrice() {
              const productPrice = parseInt(document.querySelector('.product-price').innerText.replace(',', '').replace('원', ''));
          
              const quantity = parseInt(document.querySelector('.qty-input').value);
          
              const totalPrice = productPrice * quantity;
          
              document.querySelector('[name="total-price"]').innerText = numberWithCommas(totalPrice) + '원';
            }
          
            // 버튼 클릭 시
            document.querySelector('.dec-qty').addEventListener('click', function () {
            ...
            document.querySelector('.inc-qty').addEventListener('click', function () {
              const quantityInput = document.querySelector('.qty-input');
              quantityInput.value = parseInt(quantityInput.value) + 1;
              updateTotalPrice();
            });
