...
<body>
	<div class="body-wrapper">
				...
				<div class="row align-items-center justify-content-between">
					<div class="col-lg-3 d-lg-block d-none">
						<div class="announcement-call-wrapper">
							<div class="announcement-call"></div>
						</div>
					</div>
						...
						<div
							...
							<div class="announcement-meta d-flex align-items-center">
								<a class="announcement-login announcement-text text-white"
									href="login.html"> <svg class="icon icon-user" width="10"
								...
								</a> <span class="separator-login d-flex px-3"> <svg
										width="2" height="9" viewBox="0 0 2 9" fill="none"
										xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4"
											d="M1 0.5V8.5" stroke="#FEFEFE" stroke-linecap="round" />
                                    </svg>
								</span> <a class="announcement-login announcement-text text-white"
									href="login.html"> <span>Signup</span>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-3 col-md-4 col-4">
							<div class="header-logo">
								<a href="index-shoe.html" class="logo-main"> <img
									src="assets/img/grd_logo.png" style="width: 180px;"
						...
						<div class="col-lg-6 d-lg-block d-none">
							<nav class="site-navigation">
								<ul class="main-menu list-unstyled justify-content-center">
									<li class="menu-list-item nav-item"><a class="nav-link"
										href="contact.html">오픈 예정 프로젝트</a></li>
									<li class="menu-list-item nav-item"></li>
									<li class="menu-list-item nav-item"><a class="nav-link"
										href="contact.html">펀딩 프로젝트</a></li>
									<li class="menu-list-item nav-item"></li>
									<li class="menu-list-item nav-item"><a class="nav-link"
										href="contact.html">about 작가</a></li>
									<li class="menu-list-item nav-item"></li>
									<li class="menu-list-item nav-item"><a class="nav-link"
										href="contact.html">Q&A</a></li>
								</ul>
							</nav>
						</div>
		...
		<main id="MainContent" class="content-for-layout">
			<form id="reward" method="post" action="getReward.do">
							...
							<div class="row">
								<div class="col-xl-9 col-lg-8 col-md-12 col-12">
									<div class="section-header mb-3">
										<h2 class="section-heading">리워드 선택</h2>
									</div>

									<div class="checkout-progress overflow-hidden">
										<ol class="checkout-bar px-0">
											<li class="progress-step step-active"><a
												href="geul_reward.html">리워드 선택</a></li>
											<li class="progress-step step-todo"><a
												href="geul_shipping.html">배송 정보</a></li>
											<li class="progress-step step-todo"><a
												href="geul_card.html">카드 정보</a></li>
											<li class="progress-step step-todo"><a
												href="checkout.html">결제 예약</a></li>
										</ol>
									</div>
								</div>
								<div class="col-lg-7 col-md-12 col-12">
									<table class="cart-table w-100">
										...
										<tbody>
											...
											<c:forEach var="project" items="${reward}">
												<a href="checkout_shipping.jsp?price=${project.price}&img=${project.img}&title=${project.title}">
													<!-- 프로젝트 정보 표시 -->
												...
												<tr class="cart-item">
													<td class="cart-item-media">
														<div class="mini-img-wrapper">
															<img class="mini-img" src="${project.img}" alt="img">
														</div>
													...
													<td class="cart-item-price text-end">
														<div class="product-price">${project.price}원</div>
													</td>
													<td class="cart-item-qty">
														<div class="quantity">
															<div class="quantity">
																<button type="button" class="dec-qty"
																	onclick="updateQuantity(-1)">-</button>
																<input class="qty-input" type="number" value="1" min="1"
																	max="999" onchange="updateTotalPrice()" />
																<button type="button" class="inc-qty"
																	onclick="updateQuantity(1)">+</button>
															</div>
														</div>
													</td>
								...
								<div class="col-lg-5 col-md-12 col-12">
									<div class="cart-total-area">
										<div class="subtotal-item total-price-box">
											<h4 class="subtotal-title">리워드 가격:</h4>
											<p class="subtotal-value" name="total-price"
												value="${project.price}">${project.price}원</p>
										</div>
										<div class="subtotal-item shipping-box">
											<h4 class="subtotal-title">배송비:</h4>
											<p class="subtotal-value" name="shipping-pee">3,000원</p>
										</div>

										<hr />
										<div class="subtotal-item discount-box">
											<h4 class="subtotal-title">총 결제 금액:</h4>
											<p class="subtotal-value" name="payTot">0원</p>
										</div>
										<input type="hidden" name="pj_id" value="pj-100">
										<div class="d-flex justify-content-center mt-4">
											<button type="button"
												class="position-relative btn-primary text-uppercase">배송
												정보 입력</button>
										</div>
									</div>
								</div>
		...
		<script>
			// 리워드 가격과 배송비
			const rewardPrice = parseInt(document
					.querySelector('.product-price').innerText.replace(',', '')
					.replace('원', ''));
			const shippingFee = parseInt(document
					.querySelector('[name="shipping-pee"]').innerText.replace(
					',', '').replace('원', ''));
			...
			function updateTotalPrice() {
				...
				const totalRewardPrice = rewardPrice * quantity;
				const totalPrice = totalRewardPrice + shippingFee;

				document.querySelector('[name="total-price"]').innerText = numberWithCommas(totalRewardPrice)
						+ '원';
				document.querySelector('[name="payTot"]').innerText = numberWithCommas(totalPrice)
						+ '원';
			}
		...
		<script>
			$(document).ready(function() {
				// 배송 정보 입력 페이지로 이동하는 함수
				function goToShippingPage() {
					location.href = "${path}/getAddress.do?u_id=#{u_id}";
				}

				// 리워드 선택 페이지에서 '배송 정보 입력' 버튼 클릭 시
				$(".btn-primary").on("click", function() {
					// 바로 배송 정보 입력 페이지로 이동합니다.
					goToShippingPage();
				});
			});
		</script>
...
<script>
    $(document).ready(function() {
        // 배송 정보 입력 페이지로 이동하는 함수
        function goToShippingPage() {
            location.href = "checkout_shipping.jsp";
        }
        ...
        $(".btn-primary").onclick(function() {
            ...
            const selectedReward = {
                productTitle: $(".product-title a").text(), // 상품명
                rewardPrice: $(".product-price").text(), // 리워드 가격
                quantity: parseInt($(".qty-input").val()), // 수량
                shippingFee: $(".subtotal-value[name='shipping-pee']").text(), // 배송비
                totalPrice: $(".subtotal-value[name='payTot']").text() // 총 결제 금액
            };

            $.ajax({
                type: "POST", // 전송 방식 (POST 또는 GET)
                url: "http://localhost:7080/geulYulim/checkoutReward.do", // 서버로 데이터를 전송할 URL
                data: selectedReward, // 전송할 데이터 (JSON 형태)
                success: function(response) {
                    // 성공적으로 서버로 데이터를 전송한 경우
                    console.log("리워드 정보가 서버로 전송되었습니다.");
                    // 폼을 전송합니다.
                    $("#reward").submit();
                ...
                error: function(error) {
                    // 서버로 데이터 전송에 실패한 경우
                    console.error("리워드 정보 전송에 실패했습니다: ", error);
                    alert("리워드 정보 전송에 실패했습니다. 다시 시도해주세요.");
                }
            });
        });
    });
 ...
 -->
						...
						<div class="row justify-content-between">
							<div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
								<div class="footer-widget-inner">
									<h4
										...
										<span>About</span> <span class="d-md-none"> <svg
									...
									<ul class="footer-menu list-unstyled mb-0 d-md-block">
										<li class="footer-menu-item"><a href="about-us.html">About
												us</a></li>
										<li class="footer-menu-item"><a href="about-us.html">Press
												center</a></li>
										<li class="footer-menu-item"><a href="blog.html">Our
												magazine</a></li>
										<li class="footer-menu-item"><a href="about-us.html">Our
												group</a></li>
										<li class="footer-menu-item"><a href="about-us.html">Work
												with us</a></li>
									</ul>
								</div>
							</div>
							<div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
								<div class="footer-widget-inner">
									<h4
										class="footer-heading d-flex align-items-center justify-content-between">
										<span>Shopping</span> <span class="d-md-none"> <svg
												class="icon icon-dropdown"
												xmlns="http://www.w3.org/2000/svg" width="24" height="24"
												viewBox="0 0 24 24" fill="none" stroke="#fff"
												stroke-width="1" stroke-linecap="round"
									...
									<ul class="footer-menu list-unstyled mb-0 d-md-block">
										<li class="footer-menu-item"><a href="about-us.html">Brand
												catalog</a></li>
										<li class="footer-menu-item"><a href="about-us.html">Discount
												codes</a></li>
										<li class="footer-menu-item"><a
											href="collection-left-sidebar.html">Furniture</a></li>
										<li class="footer-menu-item"><a
											href="collection-left-sidebar.html">Sofa</a></li>
										<li class="footer-menu-item"><a
											href="collection-left-sidebar.html">Chair</a></li>
									</ul>
								</div>
							</div>
							<div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
								<div class="footer-widget-inner">
									<h4
										class="footer-heading d-flex align-items-center justify-content-between">
										<span>Help</span> <span class="d-md-none"> <svg
												class="icon icon-dropdown"
												xmlns="http://www.w3.org/2000/svg" width="24" height="24"
												viewBox="0 0 24 24" fill="none" stroke="#fff"
												stroke-width="1" stroke-linecap="round"
									...
									<ul class="footer-menu list-unstyled mb-0 d-md-block">
										...
										<li class="footer-menu-item"><a href="about-us.html">Privacy
												policy</a></li>
							...
							<div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
								<div class="footer-widget-inner">
									...
									<div class="footer-newsletter">
										<p class="footer-text mb-3">Stay up to date with all the
											news.</p>
										<div class="newsletter-wrapper">
											<form action="#"
												class="footer-newsletter-form d-flex align-items-center">
												<input class="footer-newsletter-input bg-transparent"
													type="email" placeholder="Your e-mail" autocomplete="off">
										...
										<div class="footer-social-wrapper">
											<ul
												...
												<li class="footer-social-item"><a href="#"> <svg
												...
												<li class="footer-social-item"><a href="#"> <svg
															class="icon icon-tiktok" width="20" height="20"
															viewBox="0 0 20 20" fill="none"
															xmlns="http://www.w3.org/2000/svg">
                                                            <path
												...
												<li class="footer-social-item"><a href="#"> <svg
															class="icon icon-youtube" width="20" height="20"
															viewBox="0 0 20 20" fill="none"
															xmlns="http://www.w3.org/2000/svg">
                                                            <path
				...
				<div class="container">
					<div
						...
						<ul
							...
							<li class="footer-menu-item"><a href="about-us.html">Privacy
									policy</a></li>
							<li class="footer-menu-item"><a href="about-us.html">Terms
									& Conditions</a></li>
						</ul>
		...
		<!-- drawer menu start -->
		<div class="offcanvas offcanvas-start d-flex d-lg-none" tabindex="-1"
			id="drawer-menu">
			<div class="offcanvas-wrapper">
				...
				<div
						...
						<ul class="main-menu list-unstyled">
							<li class="menu-list-item nav-item has-dropdown active">
								<div class="mega-menu-header">
									<a class="nav-link active" href="index.html"> Home </a> <span
							...
							<li class="menu-list-item nav-item has-megamenu">
								<div class="mega-menu-header">
									<a class="nav-link" href="collection-left-sidebar.html">
										Shop </a> <span class="open-submenu"> <svg
											class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg"
									...
									<div class="container">
										...
										<ul class="submenu megamenu-container list-unstyled">
											<li class="menu-list-item nav-item-sub">
												<div class="mega-menu-header">
													<a class="nav-link-sub nav-text-sub megamenu-heading"
														href="collection-left-sidebar.html"> Category Pages </a> <span
														class="open-submenu"> <svg
															class="icon icon-dropdown"
															xmlns="http://www.w3.org/2000/svg" width="24" height="24"
															viewBox="0 0 24 24" fill="none" stroke="currentColor"
															stroke-width="2" stroke-linecap="round"
												...
												<div class="submenu-transform">
													...
													<ul class="megamenu list-unstyled megamenu-container">
														<li class="menu-list-item nav-item-sub"><a
															...
															href="collection-left-sidebar.html">With Left Sidebar</a>
														</li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub"
														...
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub"
															href="collection-left-sidebar.html">3 Column Layout</a></li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub"
											...
											<li class="menu-list-item nav-item-sub">
												<div class="mega-menu-header">
													<a class="nav-link-sub nav-text-sub megamenu-heading"
														href="index.html"> Product Pages </a> <span
														class="open-submenu"> <svg
															class="icon icon-dropdown"
															xmlns="http://www.w3.org/2000/svg" width="24" height="24"
															viewBox="0 0 24 24" fill="none" stroke="currentColor"
												...
												<div class="submenu-transform">
													...
													<ul class="megamenu list-unstyled">
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product.html">Simple
																Product</a></li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product.html">Variable
																Product</a></li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product.html">Sale
																Product</a></li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product.html">Featured
																& On Sale</a></li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product-2.html">Tab
																Inside</a></li>
													</ul>
												</div>
											</li>
											<li class="menu-list-item nav-item-sub">
												<div class="mega-menu-header">
													<a class="nav-link-sub nav-text-sub megamenu-heading"
														href="index.html"> Product Layouts </a> <span
														class="open-submenu"> <svg
															class="icon icon-dropdown"
															xmlns="http://www.w3.org/2000/svg" width="24" height="24"
															viewBox="0 0 24 24" fill="none" stroke="currentColor"
												...
												<div class="submenu-transform">
													...
													<ul class="megamenu list-unstyled">
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product-2.html">Grid
																Images</a></li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product.html">Vertical
																Thumb</a></li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product.html">Gallery
																Type</a></li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product.html">Product
																Width Layout</a></li>
														<li class="menu-list-item nav-item-sub"><a
															class="nav-link-sub nav-text-sub" href="product.html">Sticky
																Gallery</a></li>
													</ul>
												</div>
											</li>
											<li class="menu-list-item nav-item-sub">
												<div class="mega-menu-header">
													<a class="nav-link-sub nav-text-sub megamenu-heading"
														href="collection-left-sidebar.html"> Featured
														Collection </a>
												</div>
											</li>
										</ul>
							...
							<li class="menu-list-item nav-item has-dropdown">
								<div class="mega-menu-header">
									<a class="nav-link active" href="about-us.html"> Pages </a> <span
										class="open-submenu"> <svg class="icon icon-dropdown"
											xmlns="http://www.w3.org/2000/svg" width="24" height="24"
											viewBox="0 0 24 24" fill="none" stroke="currentColor"
											stroke-width="2" stroke-linecap="round"
								...
								<div class="submenu-transform submenu-transform-desktop">
									...
									<ul class="submenu list-unstyled">
										<li class="menu-list-item nav-item-sub"><a
											class="nav-link-sub nav-text-sub" href="about-us.html">About
												Us</a></li>
										<li class="menu-list-item nav-item-sub"><a
											class="nav-link-sub nav-text-sub" href="contact.html">Contact</a>
										</li>
										<li class="menu-list-item nav-item-sub"><a
											class="nav-link-sub nav-text-sub" href="faq.html">FAQ</a></li>
										<li class="menu-list-item nav-item-sub"><a
											class="nav-link-sub nav-text-sub" href="404.html">404
												page</a></li>
										<li class="menu-list-item nav-item-sub"><a
											class="nav-link-sub nav-text-sub" href="login.html">Login</a>
										</li>
										<li class="menu-list-item nav-item-sub"><a
											class="nav-link-sub nav-text-sub" href="register.html">Register</a>
										</li>
										<li class="menu-list-item nav-item-sub"><a
											class="nav-link-sub nav-text-sub" href="wishlist.html">Wishlist</a>
										</li>
										<li class="menu-list-item nav-item-sub"><a
											class="nav-link-sub nav-text-sub" href="cart.html">Cart</a></li>
										<li class="menu-list-item nav-item-sub"><a
											class="nav-link-sub nav-text-sub" href="checkout.html">Checkout</a>
										</li>
									</ul>
								</div>
							</li>
					...
					<ul class="utility-menu list-unstyled">
						<li class="utilty-menu-item"><a class="announcement-text"
							href="tel:+1-078-2376"> <span class="utilty-icon-wrapper">
									<svg class="icon icon-phone" xmlns="http://www.w3.org/2000/svg"
										width="24" height="24" viewBox="0 0 24 24" fill="none"
							...
							</span> Call: +1 078 2376
						</a></li>
						<li class="utilty-menu-item"><a
							class="announcement-login announcement-text" href="login.html">
								<span class="utilty-icon-wrapper"> <svg
										class="icon icon-user" width="24" height="24"
						...
						<li class="utilty-menu-item"><a
							class="header-action-item header-wishlist" href="wishlist.html">
								<span class="utilty-icon-wrapper"> <svg
										class="icon icon-wishlist" width="26" height="22"
										viewBox="0 0 26 22" fill="#000"
										xmlns="http://www.w3.org/2000/svg">
                                        <path
						...
						<li class="utilty-menu-item">
							...
							<ul class="currency-list dropdown-menu dropdown-menu-end px-2">
								<li class="currency-list-item "><a
									class="currency-list-option" href="#" data-value="USD"> <img
										class="flag" src="assets/img/flag/usd.jpg" alt="img"> <span>USD</span>
								</a></li>
								<li class="currency-list-item "><a
									class="currency-list-option" href="#" data-value="CAD"> <img
										class="flag" src="assets/img/flag/cad.jpg" alt="img"> <span>CAD</span>
								</a></li>
								<li class="currency-list-item "><a
									class="currency-list-option" href="#" data-value="EUR"> <img
										class="flag" src="assets/img/flag/eur.jpg" alt="img"> <span>EUR</span>
								</a></li>
								<li class="currency-list-item "><a
									class="currency-list-option" href="#" data-value="JPY"> <img
										class="flag" src="assets/img/flag/jpy.jpg" alt="img"> <span>JPY</span>
								</a></li>
								<li class="currency-list-item "><a
									class="currency-list-option" href="#" data-value="GBP"> <img
										class="flag" src="assets/img/flag/gbp.jpg" alt="img"> <span>GBP</span>
								</a></li>
							</ul>
						</li>
					</ul>
					...
					<div class="minicart-footer">
						<div class="minicart-calc-area">
							<div
								...
								<span class="cart-subtotal mb-0">Subtotal</span> <span
									class="cart-subprice">$1548.00</span>
							</div>
							<p class="cart-taxes text-center my-4">Taxes and shipping
								will be calculated at checkout.</p>
						</div>
						<div
							...
							<a href="cart.html" class="minicart-btn btn-secondary">View
								Cart</a> <a href="checkout.html" class="minicart-btn btn-primary">Checkout</a>
						</div>
					</div>
				</div>
