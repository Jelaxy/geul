                            ...
                            <div class="col-xl-9 col-lg-8 col-md-12 col-12">
                                ...
                                <div class="checkout-progress overflow-hidden">
                                    <ol class="checkout-bar px-0">
                                        ...
                                        <li class="progress-step step-done"><a href="checkout.html">배송 정보</a></li>
                                        <li class="progress-step step-active"><a href="checkout.html">카드 정보</a></li>
                                ...
                                <div class="shipping-address-area">
                                    ...
                                    <div class="shipping-address-form-wrapper">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-12">
                                                    <fieldset>
                                                        ...
                                                        <input type="email"  name="card-date"/>
                                                    </fieldset>
                                                </div>
                                                <div class="col-lg-6 col-md-12 col-12">
                                                    <fieldset>
                                                        <label class="label">cvc</label>
                                                        <input type="text"  name="card-cvc" placeholder="카드 뒷면 3자리를 입력해주세요">
                                                    </fieldset>
                                                </div>
                                            </div>
										...
										<script>
										  ...
										  document.querySelector('input[name="card-cvc"]').addEventListener('input', checkCardCVC);
										</script>
                                ...
                                <div class="shipping-address-area billing-area">
                                    <div class="minicart-btn-area d-flex align-items-center justify-content-between flex-wrap">
                                        <a href="checkout_shipping.jsp" class="checkout-page-btn minicart-btn btn-secondary">카드정보로 돌아가기</a>
                                        <a href="geul_checkout.html" class="checkout-page-btn minicart-btn btn-primary">결제 예약 완료하기</a>
                                    </div>
                                </div>
                            </div>
                        </div>
