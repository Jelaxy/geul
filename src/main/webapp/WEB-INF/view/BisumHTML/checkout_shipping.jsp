                     ...
                     <div class="row">
                        <div class="col-xl-9 col-lg-8 col-md-12 col-12">
                           <div class="section-header mb-3">
                              <h2 class="section-heading">회원 정보</h2>
                           </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                       <fieldset>
                                          ...
                                          <input type="text" id="phn_num" name="phn_num" />
                                       </fieldset>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-12">
                                       <fieldset>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                       <fieldset>
                                          ...
                                          <input type="text" id="ad_normal" name="ad_normal" style="width: 500px">
                                       </fieldset>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-12">
                                       <fieldset>
                                          <label class="label">상세 주소</label>
                                          <input type="text" id="ad_detail" name="ad_detail" style="width: 500px">
                                       </fieldset>
                                    </div>
                           <div class="shipping-address-area">
                              <h2 class="shipping-address-heading pb-1">카드 정보 입력</h2>
                              <div class="shipping-address-form-wrapper">
                                 <div class="row">
                                    <div class="col-lg-6 col-md-12 col-12">
                                       <fieldset>
                                          <label class="label">카드 번호</label>
                                          <input type="text" name="paycard_number" value="${card.paycard_number}" />
                                       </fieldset>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-12">
                                       <fieldset>
                                          <label class="label">유효 기간</label>
                                          <input type="text" name="expiration_date" value="${card.expiration_date}" />
                                       </fieldset>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-12">
                                       <fieldset>
                                          <label class="label">cvc</label>
                                          <input type="number" name="cvc" value="${card.cvc}" />
                                       </fieldset>
                                    </div>
                                 </div>
                                             ...
                                             function checkCardCVC() {
                                                ...
                                                if (!/^\d{3}$/
                                                      .test(cvcValue)) {
                                                   cardCVCInput
                                                         .setCustomValidity("숫자 3자리를 입력해주세요.");
                                                } else {
                                                   cardCVCInput
                                                         .setCustomValidity("");
                                                }
                                             ...
                                             <!-- cvc 유효성 검사 -->
                                                function checkCardCVC() {
                                                   ...
                                                   if (!/^\d{3}$/.test(cvcValue)) {
                                                      cardCVCInput.setCustomValidity("숫자 3자리를 입력해주세요.");
                                                   } else {
                                                      cardCVCInput.setCustomValidity("");
                                                   }
                                                }
                                       
                                                document.querySelector('input[name="cvc"]').addEventListener(
                                                      'input', checkCardCVC);
                           ...
                           <div class="shipping-address-area billing-area">
                              <div
                                 ...
                                 <a href="${path}/getReward.do?pj_id=" +pj_id
                                    class="checkout-page-btn minicart-btn btn-secondary">리워드
                                    선택으로 돌아가기</a>
                                 <a href="${path}/MyPage2.do" id="checkCom" class="checkout-page-btn minicart-btn btn-primary">결제예약 완료</a>
                              </div>
                           </div>
                        </div>
                     </div>
