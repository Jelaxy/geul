                ...
                <div class="col-sm-9">
                    ...
                    <div class="tab-list product-tab-list">
                        <nav class="nav product-tab-nav">
                            <a class="product-tab-link tab-link " href="${path}/geul/MyPage2.do" >마이 프로필</a>
                            <a class="product-tab-link tab-link active" href="${path}/geul/Mycard.do">카드 정보</a>
                            <a class="product-tab-link tab-link" href="${path}/geul/MyAddress.do" >주소 정보</a>
                        </nav>
                                       ...
                                       <div class="bg-white rounded shadow-sm container p-3">
                                        <form action="updateActioncard.do" method="post" class="shipping-address-form common-form">
                                          <input name ="u_id" type="hidden" value=${user.u_id}>
                                        
                                        <div class="col-lg-6 col-md-12 col-12">
									    <fieldset>
									        <label class="label">카드별칭</label>
									        <input type="text" name="paycard_cname" value="${user.paycard_cname}" />
									    </fieldset>
									</div>
                                          <div class="col-lg-6 col-md-12 col-12">
									    <fieldset>
									        <label class="label">카드 번호</label>
									        <input type="text" name="paycard_number" value="${user.paycard_number}" />
									    </fieldset>
									</div>
									<div class="col-lg-6 col-md-12 col-12">
									    <fieldset>
									        <label class="label">유효 기간</label> 
									        <input type="text" value='<fmt:formatDate value="${user.expiration_date}" pattern="yyyy-MM-dd"/>' />
									    </fieldset>
									</div>
									<div class="col-lg-6 col-md-12 col-12">
									    <fieldset>
									        <label class="label">cvc</label>
									        <input type="number" name="cvc" value="${user.cvc}" />
									    </fieldset>
									</div>
