                ...
                <div class="col-sm-9">
                	<div class="tab-list product-tab-list">
                        <nav class="nav product-tab-nav"  style="margin-left:540px;">
                            <a class="product-tab-link tab-link  active" href="${path}/MyPage2.do?">My Page</a>
                    ...
                    <div class="tab-list product-tab-list">
                        <nav class="nav product-tab-nav">
                            ...
                            <a class="product-tab-link tab-link"  href="${path}/geul/Mycard.do">카드 정보</a>
                            <a class="product-tab-link tab-link active" href="${path}/geul/MyAddress.do">주소 정보</a>
                        </nav>
                       
                    </div>
                    
                    <div class="bg-white rounded shadow-sm container p-3">
                        <form method="POST" action="updateAddress.do" name="updateFormad" onsubmit="return updateValidate();" class="form-horizontal" role="form">
                            ...
                            <div class="row mb-3 form-row">
     				      	<input name ="u_id" type="hidden" value=${user.u_id}>
                                ...
                                <div class="col-md-3">
                                    <input type="text" name="ad_num" id="post" 
                                        class="form-control postcodify_postcode5" value="${user.ad_num}">
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row mb-3 form-row">
                                <div class="col-md-3">
                                    <label for="ad_normal">도로명 주소</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control postcodify_address" 
                                        name="ad_normal" id="ad_normal" value="${user.ad_normal}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 form-row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control postcodify_details" 
                                        name="ad_detail" id="ad_detail" value="${user.ad_detail}">
                                </div>
                            </div>
