...
<script type="text/javascript">
	$(document).ready(function(){
		...
		if(sessName==""){
			alert("로그인이 필요합니다\n로그인 화면이동")
			location.href="${path}/geulrowding/login.do";
		}
		$("#logout").click(function(){
			if(confirm("로그아웃 하시겠습니까?"))
				location.href="${path}/geulrowding/logout.do";
		})	
	});
</script>
</head>
                   ...
                   <div class="container_a">
                    ...
                    <div class="tab-list product-tab-list">
                        <nav class="nav product-tab-nav">
                            <a class="product-tab-link tab-link active" href="${path}/geulrowding/myproject_profile.do" >작가 프로필</a>
                            <a class="product-tab-link tab-link" href="${path}/geulrowding/myproject_pjlist.do" >진행중인 프로젝트</a>
                    ...
                    <div class="bg-white rounded shadow-sm container p-3">
                           <div class="row mb-5 form-row">
                                <div class="col-md-3">
                                	<label for="phone1">프로젝트 수익금 계좌</label>
                                    <input type="text" class="form-control account" 
                                    value="${makerpage.account}"
                                        id="phone2" name="phone2" maxlength="11">
                                </div>
                            </div>
                            <br>
                            <div class="row mb-3 form-row">
                                	<label for="memberEmail">작가 한줄 소개</label>
	                                <fieldset>
	                                    <textarea class="form-control profile"  cols="120" rows="5">
	                                    ${makerpage.}
	                                    </textarea>
	                                </fieldset>
                            </div>
                            <hr class="mb-4">
                            <button type="submit" class="position-relative review-submit-btn contact-submit-btn">수정하기</button>
