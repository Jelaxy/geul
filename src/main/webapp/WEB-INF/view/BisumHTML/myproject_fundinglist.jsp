                ...
                <div class="col-sm-9">
                	<div class="tab-list product-tab-list">
                        <nav class="nav product-tab-nav"  style="margin-left:540px;">
                            ...
                            <a class="product-tab-link tab-link active" href="/geulrowding/BisumHTML/myproject_fundinglist.jsp" >My Funding</a>
                   ...
                   <br>
                    <div class="tab-list product-tab-list">
                        <nav class="nav product-tab-nav">
                        	<a class="product-tab-link tab-link" href="/geulrowding/BisumHTML/myproject_fundinglist.jsp" >나의 펀딩 목록</a>
                    ...
                    <div class="cart-page-wrapper">
                        <div class="row">
                                ...
                                <table class="cart-table w-100">
                                    <thead>
                                      <tr>
                                        <th class="cart-caption heading_18">펀딩</th>
                                        <th class="cart-caption heading_18"></th>
                                        <th class="cart-caption text-center heading_18 d-none d-md-table-cell">달성퍼센트</th>
                                        <th class="cart-caption text-end heading_18">가격</th>
                                      </tr>
                                    </thead>
                                        ...
                                        <tr class="cart-item">
                                          <td class="cart-item-media">
                                            <div class="mini-img-wrapper">
                                                <img class="mini-img" src="assets/img/project/thumbnail/id_01.jpg" alt="img">
                                            </div>                                    
                                          </td>
                                          <td class="cart-item-details">
                                            <h2 class="product-title"><a href="#">펀딩제목</a></h2>
                                            <p class="product-vendor">카테고리</p>                                   
                                          </td>
                                  ...
                                  <div class="view-all text-center" data-aos="fade-up" data-aos-duration="700">
								    <a class="btn-primary" onclick="showMoreCartItems()">SEE MORE</a>
								</div>
...
<script>
    ...
    var itemsToShow = 3; // 버튼 누르면 몇개씩 보일건지
    var currentItems = itemsToShow; // 초기에 보여주는 갯수
    var cartItems = document.getElementById("cartItems").querySelectorAll(".cart-item");

    for (var i = currentItems; i < cartItems.length; i++) {
    ...
    function showMoreCartItems() {
        for (var i = currentItems; i < currentItems + itemsToShow; i++) {
            if (cartItems[i]) {
                cartItems[i].style.display = "table-row";
            }
        }

        currentItems += itemsToShow;

        // 더이상 보여줄게 없으면  SEE MORE 버튼을 숨김 처리
        if (currentItems >= cartItems.length) {
