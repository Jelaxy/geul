...
public class Paycard_info {
	...
	// 외래키 제외
	public Paycard_info(String paycard_cname, String paycard_number, Date expiration_date, int cvc) {
		super();
	...
	// 외래키 포함
	public Paycard_info(String paycard_cname, String paycard_number, Date expiration_date, int cvc, String u_id) {
		super();
		this.paycard_cname = paycard_cname;
		this.paycard_number = paycard_number;
		this.expiration_date = expiration_date;
